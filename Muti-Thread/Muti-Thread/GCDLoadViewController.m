...
- (void)globalQueue2 {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        UIImage *image1 = [self loadImageD:imgUrl1];
        UIImage *image2 = [self loadImageD:imgUrl2];
        dispatch_async(dispatch_get_main_queue(), ^{
...
// 自定义dispatch_queue_t
- (void)defineDispatch {
    dispatch_queue_t urls_queue = dispatch_queue_create("snow", NULL);
...
-(UIImage *)loadImageD:(NSString *)url{
